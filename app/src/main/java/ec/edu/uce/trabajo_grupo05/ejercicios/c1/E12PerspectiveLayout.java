...
public class E12PerspectiveLayout extends LinearLayout {

    public E12PerspectiveLayout(Context context) {
        super(context);
        init();
    }

    public E12PerspectiveLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public E12PerspectiveLayout(Context context, AttributeSet attrs, int defStyle) {
