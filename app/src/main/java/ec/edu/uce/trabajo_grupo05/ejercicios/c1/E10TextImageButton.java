...
public class E10TextImageButton extends FrameLayout {

    private ImageView imageView;
    private TextView textView;

    /* Constructors */
    public E10TextImageButton(Context context) {
        this(context, null);
    }

    public E10TextImageButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public E10TextImageButton(Context context, AttributeSet attrs, int defaultStyle) {
