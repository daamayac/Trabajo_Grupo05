...
public class E12PerspectiveScrollContentView extends LinearLayout {
    ...
    public E12PerspectiveScrollContentView(Context context) {
        super(context);
        init();
    }

    public E12PerspectiveScrollContentView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    
    public E12PerspectiveScrollContentView(Context context, AttributeSet attrs, int defStyle) {
