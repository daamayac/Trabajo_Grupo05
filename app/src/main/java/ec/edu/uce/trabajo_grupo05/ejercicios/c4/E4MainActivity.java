...
public class E4MainActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c4e04);
        ...
        mServiceIntent = new Intent(this, E4RegionMonitorService.class);
    ...
    public void onAddGeofencesResult(int statusCode,
        ...
        startIntent.setAction(E4RegionMonitorService.ACTION_INIT);
