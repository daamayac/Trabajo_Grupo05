...
public class E03BullsEyeView extends View {
     ...
     * Java Constructor
     */
    public E03BullsEyeView(Context context) {
        this(context, null);
    }
     ...
     * XML Constructor
     */
    public E03BullsEyeView(Context context, AttributeSet attrs) {
     ...
     */
    public E03BullsEyeView(Context context, AttributeSet attrs, int defStyle) {
