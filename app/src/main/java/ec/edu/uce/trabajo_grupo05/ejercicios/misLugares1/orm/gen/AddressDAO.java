...
public interface AddressDAO extends
        ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.dao.DAO<Address> {

    /**
     * Table expression class representing table address
     */
    class AddressTableExpression extends  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.TableExpression {
        /**
         * Default constructor.
         */
        AddressTableExpression() {
            ...
            addColumn("city_id",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.INTEGER, true);
            addColumn("address",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.TEXT, true);
        }
    }
    ...
    class AddressResultSetHandler implements
            ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.ResultSetHandler<Address> {
        @Override
     ...
     */
    ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column CITY_ID = TABLE_EXPRESSION.getColumn("city_id");
    /**
