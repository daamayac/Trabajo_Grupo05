...
public interface CityDAO extends
         ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.dao.DAO<City> {

    /**
     * Table expression class representing table city
     */
    class CityTableExpression extends  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.TableExpression {
        /**
         * Default constructor.
         */
        CityTableExpression() {
            ...
            addColumn("country_id",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.INTEGER, true);
    ...
    class CityResultSetHandler implements
             ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.ResultSetHandler<City> {
        @Override
     ...
     */
     ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column COUNTRY_ID = TABLE_EXPRESSION.getColumn("country_id");
    /**
