...
public class E13RotateZoomImageView extends ImageView {
    ...
    public E13RotateZoomImageView(Context context) {
        super(context);
        init(context);
    }

    public E13RotateZoomImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public E13RotateZoomImageView(Context context, AttributeSet attrs, int defStyle) {
