...
public class E5ActionActivity extends AppCompatActivity implements AbsListView.MultiChoiceModeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                R.layout.list_itemc2e5, R.id.text, ITEMS);
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        inflater.inflate(R.menu.c2e5contextmenu, menu);
        return true;
    }
