...
public interface CountryDAO extends
        ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.dao.DAO<Country> {

    /**
     * Table expression class representing table country
     */
    class CountryTableExpression extends ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.TableExpression {
        /**
         * Default constructor.
         */
    ...
    class CountryResultSetHandler implements
            ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.ResultSetHandler<Country> {
        @Override
     ...
     * @return all rows from table funkcja.
     */
    java.util.List<Country> getCountryList(ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.AExp orderBy);
     ...
     * @return all rows from table funkcja.
     */
    java.util.List<Country> getCountryList(ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.AExp orderBy, ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.OrderByDirection asc);
     ...
     */
    java.util.List<Country> getCountryList(ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.LExp where);
