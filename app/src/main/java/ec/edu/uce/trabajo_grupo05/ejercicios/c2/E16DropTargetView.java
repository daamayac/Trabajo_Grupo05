...
public class E16DropTargetView extends ImageView implements OnDragListener {

    private boolean mDropped;

    public E16DropTargetView(Context context) {
        super(context);
        init();
    }

    public E16DropTargetView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public E16DropTargetView(Context context, AttributeSet attrs, int defaultStyle) {
