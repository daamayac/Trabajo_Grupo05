...
public class DAOProvider {
     ...
     */
    protected  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteDataSource dataSource;

    /**
     * DAOMonitor for this DAOProvider.
     */
    protected  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.DAOMonitor daoMonitor;
     ...
     */
    public DAOProvider( ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteDataSource dataSource) {
        this.dataSource = dataSource;
        this.daoMonitor = new  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.monitors.EmptyDAOMonitor();
    }
