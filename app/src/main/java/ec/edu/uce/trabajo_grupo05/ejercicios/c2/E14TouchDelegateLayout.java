...
public class E14TouchDelegateLayout extends FrameLayout {

    public E14TouchDelegateLayout(Context context) {
        super(context);
        init(context);
    }

    public E14TouchDelegateLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public E14TouchDelegateLayout(Context context, AttributeSet attrs, int defStyle) {
