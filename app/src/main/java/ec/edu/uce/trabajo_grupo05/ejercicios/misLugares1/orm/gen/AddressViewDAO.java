...
public interface AddressViewDAO extends
         ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.dao.DAO<AddressView> {

    /**
     * Table expression class representing table address_view
     */
    class AddressViewTableExpression extends  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.TableExpression {
        /**
         * Default constructor.
         */
        AddressViewTableExpression() {
            super("address_view");
            addColumn("address_id",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.INTEGER);
            addColumn("address",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.TEXT);
            addColumn("city_name",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.TEXT);
            addColumn("country_name",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.TEXT);
        }
    }
    ...
    class AddressViewResultSetHandler implements
             ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.ResultSetHandler<AddressView> {
        @Override
     ...
     */
     ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column ADDRESS = TABLE_EXPRESSION.getColumn("address");
    /**
     * Column object representing column city_name
     */
     ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column CITY_NAME = TABLE_EXPRESSION.getColumn("city_name");
    /**
     * Column object representing column country_name
     */
     ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column COUNTRY_NAME = TABLE_EXPRESSION.getColumn("country_name");
