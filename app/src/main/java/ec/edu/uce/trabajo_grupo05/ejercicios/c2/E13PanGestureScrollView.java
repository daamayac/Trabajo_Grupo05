...
public class E13PanGestureScrollView extends FrameLayout {
    ...
    public E13PanGestureScrollView(Context context) {
        super(context);
        init(context);
    }

    public E13PanGestureScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
