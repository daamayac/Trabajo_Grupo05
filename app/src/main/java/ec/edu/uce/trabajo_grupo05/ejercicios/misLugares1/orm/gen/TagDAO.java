...
public interface TagDAO extends
         ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.dao.DAO<Tag> {

    /**
     * Table expression class representing table tag
     */
    class TagTableExpression extends  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.TableExpression {
        /**
         * Default constructor.
         */
        TagTableExpression() {
    ...
    class TagResultSetHandler implements
             ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.ResultSetHandler<Tag> {
        @Override
