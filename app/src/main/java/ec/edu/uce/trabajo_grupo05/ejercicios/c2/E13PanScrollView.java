...
public class E13PanScrollView extends FrameLayout {
    ...
    public E13PanScrollView(Context context) {
        super(context);
        init(context);
    }

    public E13PanScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public E13PanScrollView(Context context, AttributeSet attrs, int defStyle) {
