...
public interface PlaceTagDAO extends
         ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.dao.DAO<PlaceTag> {

    /**
     * Table expression class representing table place_tag
     */
    class PlaceTagTableExpression extends  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.TableExpression {
        /**
         * Default constructor.
         */
        PlaceTagTableExpression() {
            super("place_tag");
            addColumn("place_id",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.INTEGER, true);
            addColumn("tag_name",  ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.SQLiteType.TEXT, true);
        }
    }
    ...
    class PlaceTagResultSetHandler implements
             ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.util.ResultSetHandler<PlaceTag> {
        @Override
     ...
     */
     ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column PLACE_ID = TABLE_EXPRESSION.getColumn("place_id");
    /**
     * Column object representing column tag_name
     */
     ec.edu.uce.trabajo_grupo05.ejercicios.misLugares1.orm.runtime.query.Column TAG_NAME = TABLE_EXPRESSION.getColumn("tag_name");
